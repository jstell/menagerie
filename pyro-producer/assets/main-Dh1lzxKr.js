import{E as q,C as A,a as B,d as k}from"./library-1cuVL6R9.js";import{v as p,l as P}from"./textures-BmA3wdwE.js";import{b as R}from"./boot-CHRYM5ge.js";import{S as u}from"./unlock-CvlgYHdK.js";const m=[{slug:"backyard-debut",name:"Backyard Debut",venue:"backyard",venueBlurb:"Your own back fence, a folding-chair crowd, and a milk crate of ground gear. No mortars — not yet.",trackSlug:"first-light",budget:160,fee:1e3},{slug:"block-party",name:"Block Party",venue:"neighborhood",venueBlurb:"The neighborhood closed the street and hired you on purpose. Bigger sky, bigger song, real expectations.",trackSlug:"ignition",budget:600,fee:1500},{slug:"town-square",name:"Town Square",venue:"civic",venueBlurb:"The civic fireworks night, in front of everyone you know. A slow, grand piece with a long quiet half — hold your nerve before the anthem lands.",trackSlug:"skyline",budget:1100,fee:2750},{slug:"main-stage",name:"Main Stage",venue:"festival",venueBlurb:"Festival headliner, and the crowd is already lit before you fire a thing. Ninety seconds, a real breakdown to hold your nerve through, and the first stage that expects fire.",trackSlug:"main-stage",budget:3200,fee:5e3}];function M(t){const e=m.find(n=>n.slug===t);if(!e)throw new Error(`unknown gig '${t}' (have: ${m.map(n=>n.slug).join(", ")})`);return e}for(const t of m)p(t.venue);const g=[{id:"effect-sparkler-bed",kind:"effect",name:"sparkler-bed",label:"Sparkler bed",blurb:"A long, soft shimmer at ground level. Holds the quietest bars without ever stealing them.",price:80},{id:"effect-whistler",kind:"effect",name:"whistler",label:"Whistlers",blurb:"A rising shriek and a small pop. Your first cue that lands on the ear before the eye.",price:120},{id:"color-blue",kind:"color",name:"blue",label:"Blue stars",blurb:"A cool third colour — another way to break a repeat.",price:150},{id:"color-green",kind:"color",name:"green",label:"Green stars",blurb:"Reads bright against gold; good for alternating runs.",price:150},{id:"effect-fountain",kind:"effect",name:"fountain",label:"Fountain",blurb:"Seven seconds of gold. The long burn that carries a whole quiet section on its own.",price:200},{id:"color-violet",kind:"color",name:"violet",label:"Violet stars",blurb:"The moody one. Sits back so the golds punch harder.",price:250},{id:"color-white",kind:"color",name:"white",label:"White stars",blurb:"Pure flash — the sharpest contrast in the palette.",price:250},{id:"effect-roman-candle",kind:"effect",name:"roman-candle",label:"Roman candles",blurb:"Eight shots on a steady beat. Ground gear that keeps time instead of just holding a note.",price:260},{id:"effect-peony",kind:"effect",name:"peony",label:"Peony shells + mortar rack",blurb:"Your first rack, and the shell to put in it. This is the night the sky opens up.",price:1200},{id:"effect-flame-jet",kind:"effect",name:"flame-jet",label:"Flame jets",price:1300,blurb:"A column of fire and a propane whump. The first cue that hits the chest instead of the ear."},{id:"effect-chrysanthemum",kind:"effect",name:"chrysanthemum",label:"Chrysanthemum shells",blurb:"A second silhouette to alternate against — a full sphere of trailing stars.",price:1400},{id:"size-2",kind:"size",name:"size-2",label:"Big shells (size L)",blurb:"Size-2 shells. The only way to land the big accents — and they sour in quiet sections. Needs a rack.",price:1600},{id:"effect-flame-wall",kind:"effect",name:"flame-wall",label:"Flame wall",price:1700,blurb:"Four seconds of fire across the whole stage. Carries a breakdown the way a fountain carries a quiet bar."},{id:"effect-willow",kind:"effect",name:"willow",label:"Willow shells",blurb:"Long drooping tails that hang in the air — a breath between hits.",price:1800},{id:"effect-crossette",kind:"effect",name:"crossette",label:"Crossette shells",blurb:"Every star splits into a cross. The highest magnitude a single cue can carry.",price:2600}];for(const t of g){if(t.kind==="effect"&&!q.some(e=>e.name===t.name))throw new Error(`shop item '${t.id}' names unknown effect '${t.name}'`);if(t.kind==="color"&&!A.some(e=>e.name===t.name))throw new Error(`shop item '${t.id}' names unknown color '${t.name}'`)}const x="pyro-save-v1";function y(){return{effects:[...u.effects],colors:[...u.colors],maxSize:u.maxSize}}function b(){return{v:2,cash:0,showsPerformed:0,best:{},owned:y()}}function N(t){if(typeof t!="object"||t===null)return y();const e=t,n=(a,i)=>Array.isArray(a)&&a.every(o=>typeof o=="string")&&a.length>0?a:i,s=e.maxSize===0||e.maxSize===1||e.maxSize===2?e.maxSize:u.maxSize;return{effects:n(e.effects,[...u.effects]),colors:n(e.colors,[...u.colors]),maxSize:s}}function G(t=localStorage){const e=t.getItem(x);if(e===null)return b();let n;try{n=JSON.parse(e)}catch{return b()}if(typeof n!="object"||n===null)return b();const s=n;if(s.v!==1&&s.v!==2||typeof s.cash!="number"||!Number.isFinite(s.cash))return b();const a={};if(typeof s.best=="object"&&s.best!==null)for(const[r,l]of Object.entries(s.best))typeof l=="number"&&Number.isFinite(l)&&(a[r]=l);const i=typeof s.showsPerformed=="number"&&Number.isFinite(s.showsPerformed)?s.showsPerformed:0,o=s.v===2?N(s.owned):y();return{v:2,cash:s.cash,showsPerformed:i,best:a,owned:o}}function C(t,e=localStorage){e.setItem(x,JSON.stringify(t))}function F(t,e,n){const s=Math.round(t.fee*e.final/100);return{fee:t.fee,bonus:s,spend:n,profit:t.fee+s-n}}function T(t,e){return e.kind==="effect"?t.owned.effects.includes(e.name):e.kind==="color"?t.owned.colors.includes(e.name):t.owned.maxSize>=2}function z(t,e){return t.cash>=e.price}function W(t,e){if(T(t,e)||!z(t,e))return null;const n={effects:e.kind==="effect"?[...t.owned.effects,e.name]:[...t.owned.effects],colors:e.kind==="color"?[...t.owned.colors,e.name]:[...t.owned.colors],maxSize:e.kind==="size"?2:t.owned.maxSize};return{...t,cash:t.cash-e.price,owned:n}}function j(t,e,n,s){const a=t.best[e];return{...t,cash:t.cash+n.profit,showsPerformed:t.showsPerformed+1,best:{...t.best,[e]:a===void 0?s:Math.max(a,s)}}}function f(t){const e=document.createElement("template");return e.innerHTML=t.trim(),e.content.firstElementChild}function O(t,e,n,s){const a=e.owned.effects.length+e.owned.colors.length+(e.owned.maxSize>=2?1:0),i=f(`
  ...
  `),o=i.querySelector("#gigBoard");for(const r of m){const l=B(r.trackSlug),d=e.best[r.slug],h=f(`
  ...
  `),i=a.querySelector("#shelf");for(const o of g){const r=T(e,o),l=z(e,o),d=f(`
    ...
    <div class="frame brief">
      ...
      <div class="sectionsRow">${i.sections.map(d=>`<span class="sectionChip" style="flex:${d.endBeat-d.startBeat}">${d.name}</span>`).join("")}</div>
  ...
  `);o.querySelector("#payoutBack").onclick=i,document.body.appendChild(o)}const v=document.getElementById("screens"),$=document.getElementById("wrap");let c=G();function w(){O(v,c,U,E)}function E(){I(v,c,K,w)}function K(t){const e=W(c,t);e!==null&&(c=e,C(c)),E()}function U(t){P(p(t.venue)),Y(v,t,c,w,()=>{location.href=`?gig=${t.slug}`})}async function H(t){v.style.display="none",$.style.display="",await P(p(t.venue)),R($,{trackSlug:t.trackSlug,gig:{budget:t.budget,owned:c.owned,venue:p(t.venue),onComplete:(e,n)=>{const s=F(t,e,n),a=e.final>(c.best[t.slug]??-1);c=j(c,t.slug,s,e.final),C(c),D(t,e,s,c,a,()=>{location.href="./"})}}})}const S=new URLSearchParams(location.search).get("gig");if(S!==null){let t=null;try{t=M(S)}catch{location.href="./"}t&&H(t)}else w();
